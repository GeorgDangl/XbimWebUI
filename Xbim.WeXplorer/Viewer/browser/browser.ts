...
import { CobieUkUtils } from './cobieuk-utils';
import { CobieUtils } from './cobie-utils';
...
export class Browser {
    ...
    */
    ...
    //compile templates
    var templateStrings = VisualTemplates();
    ...
    private _model: VisualModel = new VisualModel(null);
    private _events: any[] = [];
    private _lang: any;
    ...
    if (source instanceof Blob || source instanceof File) {
        ...
        fReader.onloadend = function () {
            if (fReader.result) {
                ...
                var utils = uk ? new CobieUkUtils(self._lang, self._culture) : new CobieUtils(self._lang, self._culture);
