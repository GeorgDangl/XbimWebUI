...
var visual_entity_1 = require("./visual-entity");
...
var CobieUkUtils = /** @class */ (function () {
    function CobieUkUtils(lang, culture) {
        ...
        this._dictionary = new attribute_dictionary_1.AttributeDictionary(lang, culture);
    }
    CobieUkUtils.prototype.getVisualEntity = function (entity, type) {
        if (!entity || !type)
            throw 'entity must be defined';
        return new visual_entity_1.xVisualEntity({
    ...
    CobieUkUtils.prototype.getValidationStatus = function (entity) {
    ...
    CobieUkUtils.prototype.getVisualModel = function (data) {
        if (!data)
        ...
        return new visual_model_1.VisualModel({
            facility: facility,
    ...
    CobieUkUtils.prototype.getContacts = function (data) {
        if (!data)
            throw 'data must be defined';
        var result = [];
    ...
    CobieUkUtils.prototype.getSpatialStructure = function (data, types) {
        if (!data)
            throw 'data must be defined';
        if (!types)
    ...
    CobieUkUtils.prototype.getZones = function (data, facility) {
        if (!data)
            throw 'data must be defined';
        if (!facility)
            throw 'data must be defined';
                ...
                for (var i = 0; i < facility.length; i++) { //facilities (always 1)
                    ...
                    for (var j = 0; j < f.children.length; j++) { //floors
                        ...
                        for (var k = 0; k < floor.children.length; k++) { //spaces
                            ...
                            if (!assignmentSet) {
                                assignmentSet = new visual_assignment_set_1.xVisualAssignmentSet();
    ...
    CobieUkUtils.prototype.getSystems = function (data, types) {
        if (!data)
            throw 'data must be defined';
        if (!types)
            throw 'types must be defined';
    ...
    CobieUkUtils.prototype.getAssetTypes = function (data) {
        if (!data)
            throw 'data must be defined';
        var result = [];
        ...
        for (var t in types) {
            ...
            for (var i in instances) {
                ...
                var assignment = new visual_assignment_set_1.xVisualAssignmentSet();
    ...
    CobieUkUtils.prototype.getProperties = function (entity) {
        if (!entity)
            throw 'entity must be defined';
        var tr = this.getTranslator();
        var result = [];
        for (var a in entity) {
            ...
            if (valStr) {
                var nameStr = tr(a);
                result.push(new visual_property_1.xVisualProperty({ name: nameStr, value: valStr, id: a }));
            }
        }
    ...
    CobieUkUtils.prototype.getCategoryProperties = function (entity) {
        ...
        for (var i = 0; i < cats.length; i++) {
            ...
            result.push(new visual_property_1.xVisualProperty({ name: cat.Classification || 'Free category', value: valStr, id: i }));
        }
        return [];
    };
    CobieUkUtils.prototype.getAttributes = function (entity) {
        if (!entity)
            throw 'entity must be defined';
        var result = [];
        ...
        for (var a in attributes) {
            ...
            result.push(new visual_attribute_1.xVisualAttribute({
                name: attribute.Name,
    ...
    CobieUkUtils.prototype.getAssignments = function (entity, type) {
        if (!entity || !type)
        ...
        for (var attrName in entity) {
            if (!entity.hasOwnProperty(attrName))
                continue;
            var assignmentSet = new visual_assignment_set_1.xVisualAssignmentSet();
    ...
    CobieUkUtils.prototype.findContact = function (email) {
    ...
    CobieUkUtils.prototype.getDocuments = function (entity, type) {
        if (!entity || !type)
            throw 'entity and type must be defined';
        var result = [];
    ...
    CobieUkUtils.prototype.getIssues = function (entity) {
        if (!entity)
            throw 'entity and type must be defined';
        var result = [];
    ...
    CobieUkUtils.prototype.setLanguage = function (lang, culture) {
        this._dictionary = new attribute_dictionary_1.AttributeDictionary(lang, culture);
    };
    CobieUkUtils.prototype.getValueString = function (value) {
    ...
    CobieUkUtils.prototype.getTranslator = function () {
        var self = this;
...
exports.CobieUkUtils = CobieUkUtils;
//# sourceMappingURL=cobieuk-utils.js.map